...
public class TripHistoryModel {
    ...
    String TripId, TripNumber, TrailorNo, TruckNo, ShipperName, ShipperAddress, ShipperStateCode, ShipperCity, ShipperPostal, ShipperCountryCode, LoadId, LoadNumber, IsRead,
            ...
            EntryTime, ExitTime, DeliveryWaitingTime, DeliverywaitingTimeReason, LoadType, QTY, LBS, KGS, JobId, IsCustomeBrokerCleared,
            LoadDeliveryDocuments, pickedDateTime, deliveredDateTime;



    public TripHistoryModel(String tripId, String tripNumber, String trailerNumber, String truckNumber, String shipperName, String shipperAddress, String shipperStateCode, String shipperCity, String shipperPostal,
                            ...
                            String isCustomeBrokerCleared, String LoadDeliveryDocuments, String dateTime, String delDateTime) {

        this.TripId = tripId;
        this.TripNumber = tripNumber;
        this.TrailorNo = trailerNumber;
        this.TruckNo = truckNumber;
        ...
        this.deliveredDateTime = delDateTime;
    ...
    public String isProrityShipment() {
        return IsProrityShipment;
    }

    public void setProrityShipment(String isProrityShipment) {
